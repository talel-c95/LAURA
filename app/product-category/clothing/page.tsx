      ...
      <div className="container section-title-container">
        <div style={{ marginBottom: "30px" }}>
          <h1 className="section-title section-title-normal" style={{ margin: 0, marginBottom: "20px" }}>
            <b></b>
            <span className="section-title-main">Clothing</span>
            <b></b>
          </h1>
              ...
              <li style={{ marginBottom: "12px" }}>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0, paddingLeft: "20px" }}>
                  <li style={{ marginBottom: "8px" }}>
                    <Link
                      href="/product-category/clothing/dresses"
                      onClick={() => setIsFilterOpen(false)}
                      style={{
                        color: "#666",
                        textDecoration: "none",
                  ...
                  <li style={{ marginBottom: "8px" }}>
                    <Link
                      href="/product-category/clothing/jackets"
                      onClick={() => setIsFilterOpen(false)}
                      style={{
                        color: "#666",
                        textDecoration: "none",
                  ...
                  <li style={{ marginBottom: "8px" }}>
                    <Link
                      href="/product-category/clothing/overalls"
                      onClick={() => setIsFilterOpen(false)}
                      style={{
                        color: "#666",
                        textDecoration: "none",
                  ...
                  <li style={{ marginBottom: "8px" }}>
                    <Link
                      href="/product-category/clothing/pants"
                      onClick={() => setIsFilterOpen(false)}
                      style={{
                        color: "#666",
                        textDecoration: "none",
                  ...
                  <li style={{ marginBottom: "8px" }}>
                    <Link
                      href="/product-category/clothing/shirts"
                      onClick={() => setIsFilterOpen(false)}
                      style={{
                        color: "#666",
                        textDecoration: "none",
                  ...
                  <li style={{ marginBottom: "8px" }}>
                    <Link
                      href="/product-category/clothing/skirts"
                      onClick={() => setIsFilterOpen(false)}
                      style={{
                        color: "#666",
                        textDecoration: "none",
